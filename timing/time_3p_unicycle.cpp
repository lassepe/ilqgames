///////////////////////////////////////////////////////////////////////////////
//
// Main GUI for three player unicycle example.
//
///////////////////////////////////////////////////////////////////////////////
...
DEFINE_double(trust_region_size, 2.0, "L_infradius for trust region.");
...
int main(int argc, char** argv) {
  const std::string log_file =
      ILQGAMES_LOG_DIR + std::string("/three_player_unicycle.log");
  ...
  auto problem =
      std::make_shared<ilqgames::ThreePlayerUnicycleExample>(params);

  // Solve the game.
  const auto t_start = std::chrono::system_clock::now();
  std::shared_ptr<const ilqgames::SolverLog> log = problem->TimedSolve();
  ...
  GLFWwindow* window = glfwCreateWindow(
      1280, 720, "ILQGames: 3-Player Unicycle Example", NULL, NULL);
